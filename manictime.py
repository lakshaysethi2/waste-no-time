...
def getLastfewHours():
    ...
    for activity in res_json['activities']:
        ...
        text += f'{activity["startTime"].split("T")[1].split("+")[0][0:5]} - {activity["endTime"].split("T")[1].split("+")[0][0:5]} - {duration} - {activity["displayName"]} - \n {activity['activity['textData'].split('Notes')[1]']} \n'
    return text 